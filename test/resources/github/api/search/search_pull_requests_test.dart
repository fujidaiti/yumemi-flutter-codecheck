...
void main() {
  group("parseResponse", () {
    test("正しいフォーマットのレスポンスをパースできる", () {
      final response = jsonDecode(_testResponse);
  ...
  "items": [
    {
      ...
      "labels_url": "https://api.github.com/repos/flutter/flutter/issues/129979/labels{/name}",
      "comments_url": "https://api.github.com/repos/flutter/flutter/issues/129979/comments",
      "events_url": "https://api.github.com/repos/flutter/flutter/issues/129979/events",
      "html_url": "https://github.com/flutter/flutter/pull/129979",
      "id": 1788867882,
      "node_id": "PR_kwDOAeUeuM5UqvZB",
      "number": 129979,
      "title": "Roll Flutter Engine from 987b621eac4e to 031c29f4f8cb (27 revisions)",
      "user": {
      ...
      "reactions": {
        "url": "https://api.github.com/repos/flutter/flutter/issues/129979/reactions",
        "total_count": 0,
        "+1": 0,
        "-1": 0,
        "laugh": 0,
      ...
      "timeline_url": "https://api.github.com/repos/flutter/flutter/issues/129979/timeline",
